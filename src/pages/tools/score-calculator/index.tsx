        ...
        <main>
            <div className={"w-[100vw] h-[100vh] flex items-center justify-center bg-white"}>
                <div
                    ...
                    <Card
                        title={<h1 className={"font-medium text-xl text-gray-700 select-none mb-0 h-fit"}>基本信息</h1>}
                    ...
                    <Card
                        title={<h1 className={"font-medium text-xl text-gray-700 select-none mb-0 h-fit"}>保存记录</h1>}
                        className={"w-11/12 h-fit "}>
                        <List dataSource={calculatorStorage.savedData}
                              renderItem={(item, index) => {
                                  return <List.Item key={index}>
                                      <div
                                          className={"w-full h-full rounded border-gray-600 border-[0px] border-solid p-4 overflow-x-scroll scrollbar-none"}>
                                          <Flex gap={"middle"} vertical={false} justify={"start"}
                                                className={"text-sm select-none"} align={"center"}>
